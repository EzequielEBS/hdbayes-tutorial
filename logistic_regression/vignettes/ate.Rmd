...
First, we define auxiliary functions to compute marginal means for treatment arms and apply them across models via Bayesian model averaging (BMA). The first function computes predictions for a given treatment arm; the second function computes marginal means for a given treatment arm; and the last function computes BMA samples.
