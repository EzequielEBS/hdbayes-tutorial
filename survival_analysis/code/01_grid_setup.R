# Set up a grid of model and prior combinations for running the real data analysis on the computing cluster
library(dplyr)
...
model <- c("PWE", "CurePWE")
# The analysis compares multiple prior specifications, including the vague prior ("ref"), power prior ("pp"),
# propensity score–integrated power prior ("psipp"), Bayesian hierarchical model ("bhm"),
